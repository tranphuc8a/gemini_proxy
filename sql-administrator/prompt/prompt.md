...
1. Tính năng chính: cung cấp công cụ quản trị hệ cơ sở dữ liệu quan hệ (mysql/mariadb) tương tự như phpmyadmin hoặc adminer...
...
- Base directory: /sql-administrator
- Có compact lại context và công việc vào sql-administrator\prompt sau khi thực hiện xong
