/** Inline 16px icons so the app ships without an icon dependency. */
...
export const ChevronIcon = (props: IconProps & { open?: boolean }) => (
  <Svg {...props}>
    <path d={props.open ? 'm6 9 6 6 6-6' : 'm9 18 6-6-6-6'} />
  </Svg>
)
