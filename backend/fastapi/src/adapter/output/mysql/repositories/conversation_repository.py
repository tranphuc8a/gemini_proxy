...
from src.domain.models import ConversationDomain
from src.application.ports.output.conversation_output_port import ConversationOutputPort

class ConversationRepository(ConversationOutputPort):
    ...
    async def get_all(self, limit: int, after: Optional[str], offset: int, order: str) -> Tuple[List[ConversationDomain], bool]:
    ...
    async def delete(self, conversation: ConversationDomain) -> None:
